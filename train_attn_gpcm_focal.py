#!/usr/bin/env python3
"""
Train Attention-GPCM using Focal Loss for handling class imbalance.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train Attention-GPCM with Focal Loss')
    ...
    # Loss and optimizer
    criterion = FocalLoss(gamma=args.gamma, alpha=alpha, n_cats=n_cats, reduction='none')
    ...
    early_stopping = EarlyStopping(patience=10, verbose=True, 
                                 path=f'save_models/best_attn_gpcm_focal_{args.dataset}.pth')
    
    print("\n" + "="*80)
    print("TRAINING ATTENTION-GPCM WITH FOCAL LOSS")
    print("="*80)
    ...
    save_path = save_results(
        ...
        f'results/train/attn_gpcm_focal_loss_{args.dataset}.json'
    )
