#!/usr/bin/env python3
"""
Train CORAL-GPCM using Focal Loss for handling class imbalance.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train CORAL-GPCM with Focal Loss')
    ...
    early_stopping = EarlyStopping(patience=10, verbose=True, 
                                 path=f'save_models/best_coral_gpcm_focal_{args.dataset}.pth')
    
    print("\n" + "="*80)
    print("TRAINING CORAL-GPCM WITH FOCAL LOSS")
    print("="*80)
    ...
    save_path = save_results(
        ...
        f'results/train/coral_gpcm_focal_loss_{args.dataset}.json'
    )
